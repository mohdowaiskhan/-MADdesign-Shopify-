...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ atlantic_Atlantic; });
...
var nodeListForEach = __webpack_require__(12);
...
var TemplateAccountAddresses_TemplateAccountAddresses = /*#__PURE__*/function () {
...
var TemplateAccountLogin_TemplateAccountLogin = /*#__PURE__*/function () {
...
var RTE_RTE = /*#__PURE__*/function () {
  function RTE(el) {
    ...
    var initContent = function initContent() {
      if (cjs["min"]('L')) {
        _this._initGroupedContent('tabs');
      } else {
        _this._initGroupedContent('accordion');
      }
  ...
  RTE_createClass(RTE, [{
    ...
    key: "_initGroupedContent",
    value: function _initGroupedContent(layout) {
      this._resetContent();
...
var AddToCartButton = /*#__PURE__*/function () {
...
var CartMini_CartMini = /*#__PURE__*/function () {
  function CartMini() {
    var _this = this;
  ...
  CartMini_createClass(CartMini, [{
    ...
    value: function removeItem(lineItem) {
      ...
      jquery_default.a.post(url, {
        ...
        if (document.querySelector('[data-section-id="static-cart"]')) {
          ...
          window.location = "".concat(window.Theme.routes.cart_url);
        } else {
          _this2.refresh();
        }
      }, 'json');
    ...
    value: function refresh() {
      ...
      var $deferred = jquery_default.a.Deferred();
      var jsonUrl = "".concat(window.Theme.routes.cart_url, ".js");
      this.el.classList.remove('cart-mini-loaded');
      jquery_default()('[data-cart-mini-item-remove]', this.el).off('click.cart-mini');
      var $deferred1 = jquery_default.a.get(jsonUrl, function (data) {
        return jquery_default()('[data-cart-mini-count]').text(data.item_count === 0 ? '' : data.item_count);
      }, 'json');
      var $deferred2 = shopify_asyncview_dist_index_es.load(window.Theme.routes.cart_url, 'mini').done(function (data) {
...
var jquery_trend = __webpack_require__(5);

// EXTERNAL MODULE: ./node_modules/jquery-revealer/jquery.revealer.js
var jquery_revealer = __webpack_require__(13);
...
var ShareThis_ShareThis = /*#__PURE__*/function () {
...
var photoswipe_ui_default = __webpack_require__(8);
...
var ProductGallery_ProductGallery = /*#__PURE__*/function () {
  function ProductGallery(el, settings) {
    ...
    var photoswipeJsonEl = this.el.querySelector('[data-photoswipe-json]');

    if (photoswipeJsonEl) {
      var photoswipeJson = JSON.parse(photoswipeJsonEl.innerHTML);
      this.imageZoom = new ImageZoom_ImageZoom(photoswipeJson.images);
      this.zoomableImages = this.viewport.querySelectorAll('[data-image-zoom]');

      this.onImageZoomClick = function (e) {
        return _this.imageZoom.open(e.currentTarget);
      };

      this.zoomableImages.forEach(function (image) {
        return _this.events.register(image, 'click', _this.onImageZoomClick);
      });
    }
...
var Product_Product = /*#__PURE__*/function () {
  ...
  Product_createClass(Product, [{
    ...
    value: function positionProductInfo(stickyNavHeight, detailsHeight) {
      var productImages = this.productArea.find('[data-product-gallery]');
      var scrollTop = this.window.scrollTop() + stickyNavHeight;
      var imagesBottom = productImages.offset().top + productImages.outerHeight(true);
    ...
    value: function addToCart() {
      ...
      jquery_default.a.ajax({
        ...
        success: function success() {
          if (_this3.data.settings.enable_cart_redirect) {
    ...
    value: function _updatePrice(variant) {
      ...
      var $priceFields = jquery_default()('.product-details__price', this.productArea);
    ...
    value: function open(url, productSha256) {
      ...
      script_default()($scripts.data('shopify-api-url'), function () {
        shopify_asyncview_dist_index_es.load(url, 'ajax', {
          ...
          var images = _this.el.querySelector('[data-product-gallery]');
...
var DynamicCollection_DynamicCollection = /*#__PURE__*/function () {
...
var DynamicImageBlock_DynamicImageBlock = /*#__PURE__*/function () {
  function DynamicImageBlock(section) {
    ...
    if (this.parallax) {
      ...
      var isNotFixed = cjs["max"]('M') && !this.fixedHeightMobile || cjs["min"]('L') && !this.fixedHeightDesktop;
...
var DynamicProduct_DynamicProduct = /*#__PURE__*/function () {
...
var DynamicSlideshow_DynamicSlideshow = /*#__PURE__*/function () {
  function DynamicSlideshow(section) {
    ...
    var firstImage = firstSlide.el.querySelector('img');
    ...
    if (this.slides.length > 0) {
      this.slides.forEach(function () {
        return _this.jumpLinksWrap.append(jquery_default()('<li>'));
      });
    }
    ...
    value: function selectedHeight(el) {
      ...
      jquery_default()(el).on('rimg:load', function () {
        _this2.timeout = setTimeout(function () {
          var slide = findSlide(_this2.slides, _this2.el.querySelector('.slide'));
          jquery_default()(el).addClass('active');
          slide.imgWrap.style.height = '';

          var isNotFixed = _this2._heightIsNotFixed();

          var imgHeight = slide.getImageHeight();

          if (isNotFixed) {
            _this2.$imageWraps.css({
              height: imgHeight
            });
          } else {
            _this2.$imageWraps.css({
    ...
    value: function autoPlaySlides() {
      ...
      if (this.slides.length > 1) {
        ...
        this.interval = setInterval(function () {
          if (!jquery_default()('.slideshow', _this3.el).hasClass('paused')) {
            _this3.nextSlide();
          }
        }, this.autoPlay);
      }
...
var DynamicVideo_DynamicVideo = /*#__PURE__*/function () {
  function DynamicVideo(section) {
    ...
    cjs["onChange"](function () {
      jquery_default()('.home-video-play-button', _this.el).on('click.video', _this.openVideo.bind(_this));
    });
...
var Static404_Static404 = /*#__PURE__*/function () {
      ...
      script_default()($scripts.data('shopify-countries'), function () {
        script_default()($scripts.data('shopify-cart'), function () {
          ...
          if (_this.settings.shipping && _this.$shippingStrings.length) {
            ...
            _this.events.push(jquery_default()('[data-shipping-calculator-submit]', _this.el).on('click.cart', _this.calculateShipping.bind(_this)), jquery_default()('#address_zip', _this.el).on('keydown.cart', _this.calculateShipping.bind(_this)));
  ...
  StaticCart_createClass(StaticCart, [{
    ...
    value: function calculateShipping(e) {
      ...
      jquery_default.a.ajax("/cart/shipping_rates.json?".concat(queryString), {
        ...
        return _this4._handleErrors(error.responseJSON || {});
...
var StaticCollectionList_StaticCollectionList = /*#__PURE__*/function () {
...
var StaticFaq_StaticFaq = /*#__PURE__*/function () {
...
var MobileNavigation_MobileNavigation = /*#__PURE__*/function () {
...
var MegaNavigation_MegaNavigation = /*#__PURE__*/function () {
...
var just_debounce = __webpack_require__(10);
  ...
  LiveSearch_createClass(LiveSearch, [{
    ...
    value: function _positionResultsContainer() {
      ...
      if (cjs["min"]('L')) {
        ...
        this.liveSearchResults.style.maxHeight = "".concat(maxHeight, "px");
      } else {
        this.liveSearchResults.addEventListener('touchmove', this.stopProp);
        this.liveSearchResults.addEventListener('scroll', this.stopProp);
        ScrollLock.lock();
    ...
    value: function _loadResults(terms) {
      ...
      shopify_asyncview_dist_index_es.load("".concat(window.Theme.routes.search_url, "?type=").concat(this.options.display.replace(/-/g, ','), "&q=").concat(terms), 'ajax', {
        hash: terms
      }).done(function (data) {
...
var StaticPageContact_StaticPageContact = /*#__PURE__*/function () {
...
var StaticSearch_StaticSearch = /*#__PURE__*/function () {
...
var StaticSubcollection_StaticSubcollection = /*#__PURE__*/function () {
...
// CONCATENATED MODULE: ./source/scripts/components/Newsletter.js
...
function Newsletter_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Newsletter_createClass(Constructor, protoProps, staticProps) { if (protoProps) Newsletter_defineProperties(Constructor.prototype, protoProps); if (staticProps) Newsletter_defineProperties(Constructor, staticProps); return Constructor; }



var Newsletter_Newsletter = /*#__PURE__*/function () {
  function Newsletter(el) {
    var _this = this;

    Newsletter_classCallCheck(this, Newsletter);

    this.el = el;
    this.$form = jquery_default()('#contact_form', this.el);
    this.$submit = jquery_default()('.submit', this.el);
    this.$newsletterWrap = jquery_default()('.newsletter-wrap', this.el);
    this.processing = false;
    this.$submit.on('click', function (e) {
      e.preventDefault();

      _this._submitNewsletter(e);
    });
  }

  Newsletter_createClass(Newsletter, [{
    key: "_submitNewsletter",
    value: function _submitNewsletter() {
      var _this2 = this;
      ...
      this.processing = true;
      this.$newsletterWrap.addClass('newsletter-submit-loading');
      jquery_default.a.ajax({
        type: 'POST',
        ...
        success: function success() {
          ...
          _this2.$newsletterWrap.removeClass('newsletter-submit-loading');

          _this2.$newsletterWrap.addClass('newsletter-submitted');
        },
        error: this.handleErrors.bind(this)
      });
    }
    ...
    key: "handleErrors",
    value: function handleErrors(response) {
      // 429 means we've hit the reCaptcha - must submit by default
      if (response.status === 429) {
        this.$form.submit();
      } else {
        var error = response.responseText;
        this.$form.append("<p class=\"error-message\">".concat(error.description, "</p>"));
        this.processing = false;
        this.$newsletterWrap.removeClass('newsletter-submit-loading');
      }
    }
  }, {
    key: "unload",
...
var StaticFooter_StaticFooter = /*#__PURE__*/function () {
  function StaticFooter(section) {
    ...
    this.el = section.el;
    this.newsletterEl = this.el.querySelector('.newsletter');
    ...
    if (this.newsletterEl) {
      this.newsletter = new Newsletter_Newsletter(this.newsletterEl);
    }
...
var atlantic_Atlantic = /*#__PURE__*/function () {
  function Atlantic() {
    var _this = this;
...
/***/ })
/******/ ]);
//# sourceMappingURL=atlantic.js.map?1601925819161